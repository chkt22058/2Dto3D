...
class MainApp:
    def __init__(self, master):
        ...
        self.load_button = tk.Button(master, text="Load OBJ", command=self.load_obj)
        self.load_button.pack()

        self.auto_rig_button = tk.Button(master, text="Auto Rig", command=self.auto_rig)
    ...
    def auto_rig(self):
        ...
        # Blenderスクリプトのパスを取得
        blender_script = os.path.join(self.script_dir, "blender_auto_rig.py")
    ...
    def preview(self):
        ...
        # Blenderスクリプトのパスを取得
        blender_script = os.path.join(self.script_dir, "blender_preview.py")
